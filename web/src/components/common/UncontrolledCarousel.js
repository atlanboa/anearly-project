...
import Carousel from '../../../node_modules/reactstrap/es/Carousel';
import CarouselItem from '../../../node_modules/reactstrap/es/CarouselItem';
import CarouselControl from '../../../node_modules/reactstrap/es/CarouselControl';
import CarouselIndicators from '../../../node_modules/reactstrap/es/CarouselIndicators';
import CarouselCaption from '../../../node_modules/reactstrap/es/CarouselCaption';
var propTypes = {
  ...
  _proto.render = function render() {
    ...
    var slides = items.map(function (item) {
      ...
      return React.createElement(CarouselItem, {
        ...
        onClick: ()=>{
          if (item.idx) {
            window.location.href=`ProductDetail/${item.idx}`
          }
        }
